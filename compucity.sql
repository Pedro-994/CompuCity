...
DROP PROCEDURE INSERTAPRODUCTO
DELIMITER $$
...
BEGIN
	IF(CANTIDAD_PROD<1) THEN
		UPDATE PRODUCTO SET ESTADO = "NO DISPONIBLE" WHERE IDPRODUCTO=NEW.IDPRODUCTO;
	END IF;
END //
...
CALL INSERTAPRODUCTO (10,'','', 56,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (10,'','', 3,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (9,'','', 91,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (9,'','', 4,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (9,'','', 76,'CARACTERISTICAS',2479.00,'DESCRIPCION');
CALL INSERTAPRODUCTO (9,'','', 92,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (7,'Liqmax II 240 Enfriamiento Liquido para CPU','Enermax', 78,'CARACTERISTICAS',1969,'DESCRIPCION','CP-ENERMAX-ELC-LMR240-BS-1.jpg','CP-ENERMAX-ELC-LMR240-BS-2.jpg','CP-ENERMAX-ELC-LMR240-BS-3.jpg','CP-ENERMAX-ELC-LMR240-BS-4.jpg');
...
CALL INSERTAPRODUCTO (9,'','', 54,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (9,'','', 80,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (10,'','', 76,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (9,'','', 2,'CARACTERISTICAS',2479.00,'DESCRIPCION');
CALL INSERTAPRODUCTO (5,'','', 76,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (10,'','', 12,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (2,'Core i3-8100','INTEL','CARACTERISTICAS',2889.00,'DESCRIPCION','CP-INTEL-BX80684I38100-2.jpg','CP-INTEL-BX80684I38100-1.jpg','CP-INTEL-BX80684I38100-3.jpg','CP-INTEL-BX80684I38100-4.jpg');
...
CALL INSERTAPRODUCTO (10,'','', 90,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (4,'micro ATX B450 AORUS M (rev. 1.0)','AORUS', 8, 8,'CARACTERISTICAS',1979,'DESCRIPCION','CP-GIGABYTE-B450AORUSM-1.jpg','CP-GIGABYTE-B450AORUSM-2.jpg','CP-GIGABYTE-B450AORUSM-3.jpg','CP-GIGABYTE-B450AORUSM-4.jpg');
...
CALL INSERTAPRODUCTO (2,'Core i7-8700','INTEL','CARACTERISTICAS',2479.00,'DESCRIPCION','CP-INTEL-BX80684I78700-1.jpg','CP-INTEL-BX80684I78700-2.jpg','CP-INTEL-BX80684I78700-3.jpg','CP-INTEL-BX80684I78700-4.jpg');
...
CALL INSERTAPRODUCTO (8,'','', 96,'CARACTERISTICAS',2479.00,'DESCRIPCION');
CALL INSERTAPRODUCTO (10,'','', 46,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (10,'','', 27,'CARACTERISTICAS',2479.00,'DESCRIPCION');
...
CALL INSERTAPRODUCTO (10,'','', 44,'CARACTERISTICAS',2479.00,'DESCRIPCION');
CALL INSERTAPRODUCTO (5,'MasterBox MB500 con Ventana RGB','CP-GAMEFACTOR-CSG501-4.webp', 54,'CARACTERISTICAS',1309.00,'DESCRIPCION','CP-COOLERMASTER-MCB-B500D-KGNN-S00-1.jpg','CP-COOLERMASTER-MCB-B500D-KGNN-S00-2.jpg','CP-COOLERMASTER-MCB-B500D-KGNN-S00-3.webp','CP-COOLERMASTER-MCB-B500D-KGNN-S00-4.jpg');
...
CALL INSERTAPRODUCTO (1,'AMD Radeon RX 590 Nitro+ 50th Anniversary Edition','Sapphire ',22,'CARACTERISTICAS',4759.00,'DESCRIPCION','CP-SAPPHIRE-11289-07-20G-10.webp','CP-SAPPHIRE-11289-07-20G-1.webp','CP-SAPPHIRE-11289-07-20G-2.webp','CP-SAPPHIRE-11289-07-20G-3.webp');
